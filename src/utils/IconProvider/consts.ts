...
export const WarcraftRoleIcon: {
  ...
  [WarcraftRole.Tank]: "ability_warrior_shieldreflection",
  [WarcraftRole.Healer]: "spell_holy_renew",
  [WarcraftRole.RangedDPS]: "inv_weapon_bow_12",
  [WarcraftRole.MeleeDPS]: "inv_sword_04",
};
